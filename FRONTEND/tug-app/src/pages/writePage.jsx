...
const WritePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // In a real app, you would upload the article to your backend here
      ...
      // Redirect to home page or article view page
  ...
  return (
    <div className="w-full max-w-6xl mx-auto mt-8 md:mt-16 lg:mt-24 p-3 sm:p-4 md:p-6 bg-amber-50 rounded-lg shadow-md">
      <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-8 text-amber-800 text-center">Create New Article</h2>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4 sm:mb-6">
          <input
            ...
            className="w-full p-2 sm:p-4 text-xl sm:text-2xl font-bold border-b-2 border-amber-300 bg-transparent focus:outline-none focus:border-amber-500"
          />
        </div>
        ...
        <div className="mb-4 sm:mb-6 p-3 sm:p-4 border-2 border-dashed border-amber-300 rounded-lg">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 gap-2">
            <h3 className="text-lg sm:text-xl font-semibold text-amber-800">Featured Image</h3>
          ...
          {showUrlInput && (
            <div className="mb-4">
              <input
                ...
                className="w-full p-2 border border-amber-300 rounded focus:outline-none focus:border-amber-500"
              />
            </div>
          )}
          ...
          {!imagePreview && (
            <div className="flex flex-col items-center justify-center h-24 sm:h-32 md:h-40 bg-amber-100 rounded">
              ...
              <p className="text-amber-600 text-sm sm:text-base">No image selected</p>
            </div>
          )}
        </div>
        ...
        <div className="mb-4 sm:mb-6">
          <textarea
            ...
            className="w-full p-3 sm:p-4 min-h-[200px] sm:min-h-[250px] md:min-h-[300px] border border-amber-300 rounded focus:outline-none focus:border-amber-500 resize-y"
          ></textarea>
        </div>
        ...
        >
          {isUploading ? (
            <>
              <svg className="animate-spin -ml-1 mr-2 sm:mr-3 h-4 w-4 sm:h-5 sm:w-5 text-amber-800" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
      ...
      <div className="mt-6 sm:mt-8 p-3 sm:p-4 bg-amber-100 rounded-lg">
        <h3 className="text-base sm:text-lg font-semibold text-amber-800 mb-2">How to Add Images:</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
          <div>
            <h4 className="font-medium text-amber-700 mb-1">Upload from Computer:</h4>
          ...
          <div>
            <h4 className="font-medium text-amber-700 mb-1">Use an Image URL:</h4>
            <ol className="list-decimal list-inside text-sm sm:text-base text-amber-900">
              <li>Click the "URL" button above</li>
              <li>Paste a direct link to an image (must end with .jpg, .png, etc.)</li>
              <li>The image will appear in the preview area if the URL is valid</li>
            </ol>
          </div>
        </div>
        <p className="mt-2 text-xs sm:text-sm text-amber-700">Supported formats: JPG, PNG, GIF, WebP. Maximum file size: 5MB.</p>
      </div>
    </div>
  );
};
