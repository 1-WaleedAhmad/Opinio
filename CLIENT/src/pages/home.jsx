...
const Home = ({ category, searchQuery }) => {
  ...
  return (
    <div className="container mx-auto px-3 sm:px-4 md:px-5 pt-12 sm:pt-16 md:pt-24" style={{ backgroundColor: 'rgb(255, 241, 173)' }}>
      {/* Hero section */}
      <div className="my-3 sm:my-5 md:my-8">
        ...
        {searchQuery && (
          <p className="text-xs sm:text-sm md:text-lg text-center text-[rgb(255,241,173)] max-w-3xl mx-auto px-2">
