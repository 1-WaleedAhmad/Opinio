    ...
    <div className="container mx-auto px-4 py-10">
      ...
      {loading && (
        <div className="text-center py-10">
          <div className="animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-amber-800 mx-auto mb-2" />
          <p className="text-amber-800">Loading articles...</p>
        </div>
      )}

      {error && (
        <div className="text-center py-10 bg-red-100 text-red-600 rounded-lg px-4">
          <p>{error}</p>
        </div>
      )}
          ...
          {hasMore && (
            <div className="flex justify-center mt-8">
              <button
                ...
                className="bg-amber-800 hover:bg-amber-700 text-white font-semibold py-2 px-6 rounded-lg transition-colors"
              >
                Load More
              </button>
            </div>
